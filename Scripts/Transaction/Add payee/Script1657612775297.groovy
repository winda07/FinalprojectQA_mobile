...
Mobile.tap(findTestObject('Payment/add_paye'), 0)

Mobile.setText(findTestObject('Payment/input_payee_name'), 'spotify', 0)

Mobile.tap(findTestObject('Payment/btn_add'), 0)
